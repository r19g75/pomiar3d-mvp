...
export function PointPanel({ point, startInEdit, onSave, onClose }: {
  point: Point3D
  startInEdit: boolean
  ...
  return (
    <div className="check-card wall-panel">
      <div className="card-title"><h2>Punkt {point.id}</h2><button className="secondary" onClick={onClose}>Zamknij</button></div>
      {!editing ? (
        <>
